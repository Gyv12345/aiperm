...
public class AuthController {
    ...
    @GetMapping("/captcha")
    @RateLimit(count = 30, windowSeconds = 60, scope = AccessLimitScope.IP, key = "auth:captcha", message = "验证码请求过于频繁，请稍后重试")
    ...
    @PostMapping("/login")
    @RateLimit(count = 10, windowSeconds = 60, scope = AccessLimitScope.IP, key = "auth:login", message = "登录请求过于频繁，请稍后重试")
    ...
    @RateLimit(count = 10, windowSeconds = 60, scope = AccessLimitScope.IP, key = "auth:unified-login", message = "登录请求过于频繁，请稍后重试")
