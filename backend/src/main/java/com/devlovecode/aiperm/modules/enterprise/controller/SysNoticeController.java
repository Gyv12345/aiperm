...
public class SysNoticeController {
	...
	public R<List<NoticeVO>> published(@RequestParam(name = "type", required = false) Integer type,
	...
	@GetMapping("/feed")
	public R<List<NoticeVO>> feed(@RequestParam(name = "type", required = false) Integer type,
			@RequestParam(name = "limit", defaultValue = "10") Integer limit) {
		return R.ok(noticeService.findPublished(type, limit));
	}
