...
public class EmailLoginStrategy implements LoginStrategy {
	...
	public EmailLoginStrategy(SystemAccess systemAccess, LoginAuditApi loginAuditApi,
			OnlineSessionApi onlineSessionApi, @Qualifier("emailCaptchaService") CaptchaService emailCaptchaService) {
	...
	public LoginVO login(String identifier, String credential, String ip, String userAgent,
		...
		SystemUserAccount user = systemAccess.findUserByEmail(identifier)
