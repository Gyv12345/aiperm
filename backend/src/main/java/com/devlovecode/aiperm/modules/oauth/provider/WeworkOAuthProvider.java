 ...
 * 企业微信 OAuth 提供者
 *
 * 注意：企业微信 OAuth 流程比较复杂，此实现为基础框架。
 * 实际项目需要根据企业微信最新 API 文档进行调整。
 *
 * @see <a href="https://developer.work.weixin.qq.com/document/path/91022">企业微信 OAuth 文档</a>
 */
@Component
public class WeworkOAuthProvider extends AbstractOAuthProvider {
    ...
    protected OAuthUserInfo fetchUserInfo(String accessToken, SysOauthConfig config) {
        ...
        throw new UnsupportedOperationException(
            "WeworkOAuthProvider.fetchUserInfo 需要根据企业微信实际 API 实现。" +
