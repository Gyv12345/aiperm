...
import com.devlovecode.aiperm.modules.system.rbac.service.DictTypeService;
...
public class SysDictTypeController {
	...
	@Log(title = "字典类型管理", operType = OperType.EXPORT)
	@GetMapping("/export")
	public void export(@Validated({ Default.class, Views.Query.class }) DictTypeDTO dto, HttpServletResponse response) {
		dictTypeService.export(dto, response);
	}
